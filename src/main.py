"""
Main Demo for DHWAJA Guidance Kit
Demonstrates sensor simulation, Kalman filter fusion, and visualization.
"""
...
def simulate_trajectory():
    """
    Simulate a simple trajectory: constant velocity in x-direction with some noise.
    """
